...
class TestContentBlock:
    ...
    def test_image_url_content(self):
        ...
        block = ContentBlock(
            type="image", image_url="https://example.com/image.png", mime_type="image/png"
        )
    ...
    def test_image_base64_content(self):
        ...
        block = ContentBlock(
            type="image", image_base64="iVBORw0KGgoAAAANS...", mime_type="image/png"
        )
        assert block.type == "image"
...
class TestUnifiedRequest:
    ...
    def test_minimal_request(self):
        ...
        req = UnifiedRequest(
            model="gpt-4o-mini", messages=[UnifiedMessage(role="user", content="Hello")]
        )
...
class TestUnifiedStreamChunk:
    ...
    def test_stream_chunk(self):
        ...
        chunk = UnifiedStreamChunk(
            content="Hello", finish_reason=None, raw_chunk={"data": "raw"}
        )
    ...
    def test_final_chunk(self):
        ...
        chunk = UnifiedStreamChunk(content="", finish_reason="stop", raw_chunk=None)
